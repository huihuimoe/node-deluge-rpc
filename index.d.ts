...
export interface DelugeRPCStatic {
  new(delugeRpcBaseUrl: string, rpcPassword?: string): DelugeRPCInstance;
}

export interface DelugeRPCInstance {
  delugeRpcBaseUrl: string;
  rpcPassword: string;
  cookie: string;
  msgId: number;
  ...
  getTorrentRecord(): Promise<DelugeTorrentRecord>;
  addTorrent(torrent: string | URL | Buffer | Promise<Buffer> | ReadableStream | File | Blob, config?: string | DelugeTorrentConfig): Promise<boolean>
}

declare const DelugeRPC: DelugeRPCStatic;
